...
class BattleManager {
    ...
    async syncProgress() {
        ...
        const playerRef = this.dbRefs.ref(this.db, `rooms/${this.currentRoom}/players/${this.playerName}`);
    ...
    setupPresence(roomCode, playerName) {
        const playerRef = this.dbRefs.ref(this.db, `rooms/${roomCode}/players/${playerName}`);
